    ...
    <body>
        ...
        <div id="container">
            ...
            <div id="header">
                ...
                <a href=<?php echo base_url();?>><IMG class="logo" src= <?php echo base_url('assets/img/hearthstone.jpg');?>></a>
                ...
                <ul id="list-nav">
                 ...
                 <?php
                    ...
                    if ($this->session->userdata('is_logged_in')) {
						 echo '<a href="' . base_url("logout") . '" class="login_link">Log Out</a>';
						}else {
                        echo '<a href="' . base_url("register") . '" class="register_link">Register</a>';
                        echo '<a href="' . base_url("login") . '" class="login_link">Log in</a>';
                    }
				  ?>
                <!-- /navigation -->
